...
class Scenario(BaseScenario):
    ...
    def observation(self, agent:Agent, world:World) -> np.ndarray:
        ...
        if self.obs_type == 'local':
            ...
            other_pos = np.array(other_agents_pos + obstacle_pos)   # remember + is just concatenation of lists
...
if __name__ == "__main__":
    ...
    env = MultiAgentCADRLEnv(world=world, reset_callback=scenario.reset_world, 
