...
class WandbLogger:
    def __init__(self, experiment_name:str, save_folder:str, project:str, 
        ...
        wandb.init(project=project, entity=entity, sync_tensorboard=True,
                    ...
                    save_code=True, dir=save_folder, **kwargs)
    ...
    def add_histogram_raw(self, tag, min, max, num, sum, sum_squares, 
                        ...
                        walltime=None):
        self.writer.add_histogram_raw(tag, min, max, num, sum, sum_squares, 
    ...
    def add_image_with_boxes(self, tag, img_tensor, box_tensor, global_step=None,
        ...
        self.writer.add_image_with_boxes(tag, img_tensor, box_tensor, global_step,
                                    walltime, rescale, dataformats, labels)
    ...
    def add_pr_curve_raw(self, tag, true_positive_counts, false_positive_counts,
                        true_negative_counts, false_negative_counts, precision,
                        recall, global_step=None, num_thresholds=127, 
                        weights=None, walltime=None):
        self.writer.add_pr_curve_raw(tag, true_positive_counts, false_positive_counts,
                        true_negative_counts, false_negative_counts, precision,
                        recall, global_step, num_thresholds, weights, walltime)

    def add_custom_scalars_multilinechart(self, tags, category='default', 
                                        title='untitled'):
        self.writer.add_custom_scalars_multilinechart(tags, category, title)

    def add_custom_scalars_marginchart(self, tags, category='default', 
                                        title='untitled'):
    ...
    def add_mesh(self, tag, vertices, colors=None, faces=None, config_dict=None, 
                global_step=None, walltime=None):
        self.writer.add_mesh(tag, vertices, colors, faces, config_dict, 
