...
class GMADDPG_Actor(nn.Module):
    def __init__(self,
        ...
        node_obs_dim = get_shape_from_obs_space(node_obs_space)[1] # returns (num_nodes, num_node_feats)
        ...
        self.act = ACTLayer(act_dim, self.hidden_size, 
...
class GMADDPG_Critic(nn.Module):
    ...
    def __init__(self,
        ...
        node_obs_dim = get_shape_from_obs_space(node_obs_space)[1]  # (num_nodes, num_node_feats)
