...
class VDNMixer(nn.Module):
    ...
    def forward(self, agent_q_inps, states):
        ...
        # changing this to match pymarl2
        # https://github.com/hijkzzz/pymarl2/blob/1c691e30e6bcbebbcd8f7bfd92efd50a9a59a5c1/src/modules/mixers/vdn.py#L10
        # unsqueezing because squeezing happens in qmix.py
        return agent_q_inps.sum(dim=-1, keepdim=True).unsqueeze(-1)
