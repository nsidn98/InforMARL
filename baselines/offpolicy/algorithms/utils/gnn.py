...
class TransformerConvNet(nn.Module):
    ...
    def forward(self, node_obs:Tensor, adj:Tensor, agent_id:Tensor):
        ...
        for i in range(batch_size):
            ...
            datalist.append(Data(x=node_obs[i], edge_index=edge_index, 
                            edge_attr=edge_attr))
