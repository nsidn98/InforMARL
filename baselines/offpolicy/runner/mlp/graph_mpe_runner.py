    ...
    def shared_collect_rollout(self, explore=True, training_episode=True, warmup=False):
        ...
        for step in range(self.episode_length):
            ...
            if warmup:
                ...
                acts_batch, _ = policy.get_actions(obs_batch, node_obs_batch, 
                                                    adj_batch, agent_id_batch, 
            ...
            next_obs, next_agent_id, next_node_obs, next_adj, rewards, \
                    dones, infos = env.step(env_acts)
