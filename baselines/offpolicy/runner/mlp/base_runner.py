...
from baselines.offpolicy.utils.mlp_buffer import MlpReplayBuffer, PrioritizedMlpReplayBuffer
from baselines.offpolicy.utils.util import is_discrete, is_multidiscrete, DecayThenFlatSchedule
...
class MlpRunner(object):
    ...
    def __init__(self, config):
        ...
        if self.algorithm_name == "matd3":
            from baselines.offpolicy.algorithms.matd3.algorithm.MATD3Policy import MATD3Policy as Policy
            from baselines.offpolicy.algorithms.matd3.matd3 import MATD3 as TrainAlgo
        elif self.algorithm_name == "maddpg":
            from baselines.offpolicy.algorithms.maddpg.algorithm.MADDPGPolicy import MADDPGPolicy as Policy
        ...
        #     from offpolicy.algorithms.masac.masac import MASAC as TrainAlgo
            ...
            from baselines.offpolicy.algorithms.mqmix.algorithm.mQMixPolicy import M_QMixPolicy as Policy
            from baselines.offpolicy.algorithms.mqmix.mqmix import M_QMix as TrainAlgo
        elif self.algorithm_name == "mvdn":
            from baselines.offpolicy.algorithms.mvdn.algorithm.mVDNPolicy import M_VDNPolicy as Policy
