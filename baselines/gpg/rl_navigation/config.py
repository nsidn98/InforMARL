...
def get_config():
    ...
    # prepare parameters
    parser.add_argument("--algorithm_name", type=str, default='gpg')

    parser.add_argument("--project_name", type=str, default="test",
                        help="project name to store logs under")
    parser.add_argument("--experiment_name", type=str, default="gpg", 
    ...
    parser.add_argument('--scenario_name', type=str,
                        default='navigation_gpg', help="Which scenario to run on")
    parser.add_argument('--graph_type', type=str, choices=['dynamic', 'static'],
                        default='static', help="Whether to use dynamic graph or not")
