...
def get_config():
    ...
    parser.add_argument("--experiment_name", type=str, default="dgn", 
    ...
    parser.add_argument('--scenario_name', type=str,
                        default='navigation_dgn', help="Which scenario to run on")
    parser.add_argument('--model_name', type=str,
                        default='dgn_orig', help="Which model to run on. "
                        "the other option is dgn_atoc")
    ...
    parser.add_argument("--hidden_dim", type=int, default=64, 
                        help="hidden dimension for DGN")
    parser.add_argument("--capacity", type=int, default=65000, 
                        help="buffer size")
    parser.add_argument("--batch_size", type=int, default=64, 
                        help="batch size")
    parser.add_argument("--n_epoch", type=int, default=25, 
                        help="number of epoch for each episode")
    parser.add_argument("--epsilon", type=float, default=0.9, 
                        help="epsilon value for exploration")
    parser.add_argument("--comm_flag", type=int, default=1, 
                        help="Flag to enable graph communication") # TODO what's this????
