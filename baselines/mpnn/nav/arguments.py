...
def get_args():
    ...
    parser.add_argument("--obs_type", type=str, choices=['local', 'global', 'nbd'],
                        default='local', help="Whether to use local obs for navigation.py")
    ...
    parser.add_argument('--entity-mp', type=lambda x:bool(strtobool(x)), 
                        default=True, help='enable entity message passing')
