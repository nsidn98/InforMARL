...
logs_folder="out_informarl10_32"
mkdir -p $logs_folder
# Run the script
seed_max=5
n_agents=10
...
--seed ${seed} \
--experiment_name "informarl_${ep_lens[$SLURM_ARRAY_TASK_ID]}_32" \
--scenario_name "navigation_graph" \
--num_agents=${n_agents} \
--collision_rew 5 \
--n_training_threads 1 --n_rollout_threads 32 \
--num_mini_batch 1 \
